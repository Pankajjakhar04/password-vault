...
export default function Home() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center px-6 py-16 text-zinc-100">
        ...
        <div className="glass-card rounded-3xl px-8 py-12 sm:px-12">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <Link
                href="/unlock"
                className="inline-flex h-12 items-center justify-center rounded-full bg-[color:var(--vault-accent)] px-6 text-sm font-semibold text-black transition hover:shadow-[0_0_20px_rgba(0,255,136,0.5)]"
              >
                Unlock Vault
              </Link>
              <Link
                href="/setup"
                className="inline-flex h-12 items-center justify-center rounded-full border border-[color:var(--vault-border)] px-6 text-sm font-semibold text-zinc-100 transition hover:border-[color:var(--vault-accent)]"
              >
                First-time setup
              </Link>
            </div>
